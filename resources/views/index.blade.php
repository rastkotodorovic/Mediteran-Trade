...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&display=swap" media="all" />
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="iconbox style2 v2">
                        ...
                        <div class="iconbox-content">
                            <h4>76300 Bijeljina,</h4>
                            <p>Agrotržni centar, BiH</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="iconbox style2 v2">
                        ...
                        <div class="iconbox-content">
                            <h4>Pon - Pet: 8 h - 16 h</h4>
                            <p>Vikend: Ne radimo</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <ul><!-- SLIDE  -->
                ...
                <li data-index="rs-3050" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">    <div class="overlay-black"></div>
                    ...
                    <div class="tp-caption title-slide color-white letter-spacing3px"
                        ...
                        style="z-index: 16; white-space: nowrap;">Podigni svoje poslovanje na veći nivo
                    </div>
                    ...
                    <div class="tp-caption sub-title color-white"
                        ...
                        style="z-index: 17; white-space: nowrap;">Računovodstvena agencija Mediteran vam pruža mnoštvo knjigovodstvenih usluga.
                    </div>
                    ...
                    data-width="['auto']"
                    data-height="['auto']">Pročitaj više
                    </a><!-- END LAYER LINK -->
                    ...
                    data-fontsize="['14',14','14','14']"
                    data-width="['auto']"
                    data-height="['auto']">Kontaktiraj nas
                    </a><!-- END LAYER LINK -->
                </li>
...
<!-- Javascript -->
<script async type="text/javascript" src="javascript/jquery.min.js"></script>
...
<script async type="text/javascript" src="javascript/jquery.easing.js"></script>
...
<script async type="text/javascript" src="javascript/jquery-countTo.js"></script>
<script async type="text/javascript" src="javascript/jquery.owl-filter.js"></script>
<script async type="text/javascript" src="javascript/jquery.fancybox.js"></script>
<script async type="text/javascript" src="javascript/jquery.cookie.js"></script>
<script async type="text/javascript" src="javascript/jquery-validate.js"></script>
...
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script async type="text/javascript" src="revolution/js/extensions/revolution.extension.video.min.js"></script>
